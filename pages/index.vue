  ...
  <div>
    ...
    <v-container>
      ...
      <p v-if="$i18n.locale == 'en'">
        <a href="e_about.html">This image database</a> contains digital images
        of Giovanni Battista Piranesi's original etchings from
      ...
      <p v-else>
        <a href="about.html">このデータベース</a
        >は，東京大学附属図書館（総合図書館）所蔵 の亀井文庫『ピラネージ版画集
        <i>
      ...
      <v-row class="mb-5">
        <v-col cols="3">
          <v-card outlined>
            <v-list-item
              :to="localePath({ path: '/catalog_cdml', query: { volume: 1 } })"
              three-line
            >
              <v-list-item-content>
        ...
        <v-col cols="3">
          <v-card outlined>
            <v-list-item :to="{ path: '/about' }" three-line>
              <v-list-item-content>
                <v-list-item-title class="headline mb-1">
                  {{ $t('message.text_search') }}
                </v-list-item-title>
                <v-list-item-subtitle>
                  {{ $t('message.text_search_about') }}
                </v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
          </v-card>
